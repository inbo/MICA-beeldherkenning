...
assetsCOR <- read.csv("./data/Agouti_raw/assets.csv", sep = ",")
observationsCOR <- read.csv("./data/Agouti_raw/observations.csv", sep = ",")
pickup_setupCOR <- read.csv("./data/Agouti_raw/pickup_setup.csv", sep = ",")

# Make them empty


# Get new data fitted into old format
assetsNEW <- read.csv("./data/raw/assets.csv")
observationsNEW <- read.csv("./data/raw/observations.csv")
pickup_setupNEW <- read.csv("./data/raw/pickup_setup.csv")
...
# Save new datasets
write.csv(assets, "./data/raw/assets.csv")
write.csv(observations, "./data/raw/observations.csv")
write.csv(pickup_setup, "./data/raw/pickup_setup.csv")